...
/**
 * 更改 session redis中的cookie name
 * @author: shawn-gfresh  create by:2017年9月14日 上午9:37:31 
 *   
 * @version V1.0
 */
@Component
public class GfreshCookieSerializer implements CookieSerializer {
	private String cookieName = "_c_z_";
	...
	private String base64Decode(String base64Value) {
		try {
			byte[] decodedCookieBytes = Base64.getDecoder().decode(base64Value.getBytes());
