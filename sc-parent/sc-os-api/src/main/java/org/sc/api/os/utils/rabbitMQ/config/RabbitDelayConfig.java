package org.sc.api.os.utils.rabbitMQ.config;
...
public class RabbitDelayConfig {
     ...
     * 延迟队列 TTL 名称
     */
    private static final String REGISTER_DELAY_QUEUE = "lv_delay_queue";
    /**
     * DLX，dead letter发送到的 exchange
     * TODO 此处的 exchange 很重要,具体消息就是发送到该交换机的
     */
    public static final String REGISTER_DELAY_EXCHANGE = "lv_delay_exchange";
    /**
     * routing key 名称
    ...
    public static final String REGISTER_QUEUE_NAME = "lv_queue";
    public static final String REGISTER_EXCHANGE_NAME = "lv_exchange";
