...
public class AliyunOSSClientUtil {
	 ...
	 * @return ossClient
	 */
	public static  OSSClient getOSSClient(String endPoint, String accesskeyId, String keySecret){
		return new OSSClient(endPoint, accesskeyId, keySecret);
	 ...
	 * */
	public static final String uploadObject2OSS(OSSClient client, InputStream is, int fileSize, String bucketName, String diskName,String fileName) {
		String resultStr = null;
		try {
			//创建上传Object的Metadata
			ObjectMetadata metadata = new ObjectMetadata();
	...
	public static void uploadObject(
		...
		createFolder(ossClient, bucketName, filePath);
		uploadObject2OSS(ossClient, inputStream,contentLength, bucketName, filePath,fileName);
		ossClient.shutdown();
	}
