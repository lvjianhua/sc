 ...
 * 枚举工具类 根据值获取对应的枚举对象
 * 
 * @author: shawn-gfresh create by:2017年4月26日 下午2:52:11
 * 
 * @version V1.0
 */
public class EnumHelperUtil {
	/**
	 * indexOf,传入的参数ordinal指的是需要的枚举值在设定的枚举类中的顺序，以0开始 T
	 * 
	 * @param clazz
	 * @param ordinal
	 * @return
	...
	/**
	 * nameOf,传入的参数name指的是枚举值的名称，一般是大写加下划线的 T
	 * 
	 * @param clazz
	 * @param name
	 * @return Enum T
