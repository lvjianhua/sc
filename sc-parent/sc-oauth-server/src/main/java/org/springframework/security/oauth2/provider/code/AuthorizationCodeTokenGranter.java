...
public class AuthorizationCodeTokenGranter extends AbstractTokenGranter {
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		if ((redirectUri != null || redirectUriApprovalParameter != null)
			...
			String storeRedirectUri = pendingOAuth2Request.getRedirectUri();
			requestRedirectUri = redirectUri == null ? "" : redirectUri;
			...
			// 判断http和https
			logger.debug("pendingOAuth2Request.redirectUri------------------------:"
					+ pendingOAuth2Request.getRedirectUri() + "=============" + storeRedirectUri);
			logger.debug("redirectUri------------------------:" + redirectUri + "=============" + requestRedirectUri);

			if (!storeRedirectUri.equals(requestRedirectUri)) {
	...
	public static void main(String[] args) {
		...
		System.out.println(storeRedirectUri + "---------" + requestRedirectUri);

		if (!storeRedirectUri.equals(requestRedirectUri)) {
			System.out.println("------------" + "Redirect URI mismatch.");
		} else {
